...
T = TypeVar("T", bound="ShotRegisters")



@_attrs_define
class ShotRegisters:
    """ Per-register bit arrays for one shot, keyed by register name.
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        shot_registers.additional_properties = additional_properties
        return shot_registers
