...
T = TypeVar("T", bound="ErrorMitigationOutputDebiasingType1")
...
class ErrorMitigationOutputDebiasingType1:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        error_mitigation_output_debiasing_type_1 = cls(
            variants=variants,
            aggregation_method=aggregation_method,
        )


        error_mitigation_output_debiasing_type_1.additional_properties = d
        return error_mitigation_output_debiasing_type_1
