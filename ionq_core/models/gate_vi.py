...
from ..models.gate_vi_gate import check_gate_vi_gate
from ..models.gate_vi_gate import GateViGate
from ..types import UNSET, Unset
...
T = TypeVar("T", bound="GateVi")



@_attrs_define
class GateVi:
    """ V-dagger (inverse of V).
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        gate = check_gate_vi_gate(d.pop("gate"))
