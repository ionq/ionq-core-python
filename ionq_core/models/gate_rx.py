...
from ..models.gate_rx_gate import check_gate_rx_gate
from ..models.gate_rx_gate import GateRxGate
from ..types import UNSET, Unset
...
class GateRx:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        d = dict(src_dict)
        gate = check_gate_rx_gate(d.pop("gate"))
